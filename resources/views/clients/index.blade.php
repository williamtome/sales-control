                ...
                <table class="divide-y divide-gray-300">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $client->address->city }}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $client->address->state }}
                            </td>
                            <td
